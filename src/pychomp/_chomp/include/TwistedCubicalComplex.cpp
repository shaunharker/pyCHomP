...
class TwistedCubicalComplex : public Complex {
public:
  /// TwistedCubicalComplex
  ///   Default constructor
  TwistedCubicalComplex ( void ) {}
  ...
  TwistedCubicalComplex ( std::vector<Integer> const& boxes ) {
    assign ( boxes );
  }
  ...
  /// operator ==
  bool
  operator == ( TwistedCubicalComplex const& rhs ) const {
  ...
  /// operator <<
  friend std::ostream & operator << ( std::ostream & stream, TwistedCubicalComplex const& stream_me ) {
    stream << "TwistedCubicalComplex([";
...
/// std::hash<TwistedCubicalComplex>
namespace std {
  template<> struct hash<TwistedCubicalComplex> {
    typedef TwistedCubicalComplex argument_type;
...
inline void
TwistedCubicalComplexBinding(py::module &m) {
  py::class_<TwistedCubicalComplex, std::shared_ptr<TwistedCubicalComplex>, Complex>(m, "TwistedCubicalComplex")
    .def(py::init<>())
    .def(py::init<std::vector<Integer> const&>())
    .def("boxes", &TwistedCubicalComplex::boxes)
    .def("coordinates", &TwistedCubicalComplex::coordinates)
    .def("barycenter", &TwistedCubicalComplex::barycenter)    
    .def("cell_type", &TwistedCubicalComplex::cell_type)
    .def("cell_shape", &TwistedCubicalComplex::cell_shape)
    .def("cell_pos", &TwistedCubicalComplex::cell_pos)
    .def("cell_dim", &TwistedCubicalComplex::cell_dim)
    .def("cell_index", &TwistedCubicalComplex::cell_index)
    .def("left", &TwistedCubicalComplex::left)
    .def("right", &TwistedCubicalComplex::right)
    .def("leftfringe", &TwistedCubicalComplex::leftfringe)
    .def("rightfringe", &TwistedCubicalComplex::rightfringe)
    .def("mincoords", &TwistedCubicalComplex::mincoords)
    .def("maxcoords", &TwistedCubicalComplex::maxcoords)
    .def("parallelneighbors", &TwistedCubicalComplex::parallelneighbors);
}
